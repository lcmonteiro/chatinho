...
The popup lists the registered commands. They are registered via ``create_chat(peers=[...])``; the popup shows
...
from chatinho import HookExecute, create_chat, require, tool
